...
const Login: React.FC<any> = () => {
    ...
    if(response.status === 202) {//if the login was successful...
        ...
        //populate our user object from a bove with incoming data from the server
    ...
    return (
        <div className='Login'>
            ...
            <div className="disclaimer">
                <p>The Pokemon Exchange and its afiliates do not condone the misuse or mistreatment of Pokemon</p>
            </div>
        </div>
    )
